# Develop your first addon

In this tutorial, you will learn how to set up a mod development environment and create a Valkyrien Skies addon 
from scratch, using the Valkyrien Skies Addon Template.

![addon_template.png](addon_template.png)
...
1. Grab the VS Addon Template! You can get it from its **[releases page](https://github.com/ValkyrienSkies/Valkyrien-Skies-Addon-Template/releases)**. Make sure to grab the **latest** release.
   - (Grab the **FORGE** zip if you only wish to develop for Forge, or the **MULTILOADER** zip if you wish to develop for Fabric & Forge simultaneously.)
2. Unzip the template to a folder of your choice.
3. Open the project in your preferred IDE (IntelliJ IDEA is strongly recommended).
4. Import the Gradle project when prompted.
5. Wait for Gradle to finish downloading dependencies. This can take a minute or two on the first run.

Once it's setup, you're good to go! Now, onto the basics of your addon itself.
